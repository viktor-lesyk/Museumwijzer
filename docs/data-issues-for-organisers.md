...
Across the 195 participating museum records scraped from `welkominhetmuseum.vriendenloterij.nl`, our validation pipeline and identity verification tooling identified **17 specific records** requiring editorial attention:
...
- **4 Postal Code Inconsistencies & Typos:** Typos or misplaced Dutch 4-digit postal codes that break geocoding, public transit routing, and navigation apps.
...
| **12** | **Museum Volkenkunde / Wereldmuseum Leiden** | `museum-volkenkunde` | Postcode: *1624 NN* (Hoorn) | Postcode: **2312 BS**<br>Address: Steenstraat 1, 2312 BS Leiden<br>Website: `https://leiden.wereldmuseum.nl/` | [wereldmuseum.nl](https://leiden.wereldmuseum.nl/nl/over-wereldmuseum-leiden/contact) ("Bezoekadres: Steenstraat 1, 2312 BS Leiden") | **Medium:** Postcode `1624 NN` belongs to Hoorn (Noord-Holland), not Leiden. Causes route planners and navigation apps to direct visitors to the wrong town. *Note:* The museum has also officially rebranded to **Wereldmuseum Leiden**. |
| **13** | **Museum Tachtigjarige Oorlog** | `museum-tachtigjarige-oorlog` | Province: *Groningen* | Province: **Gelderland**<br>Address: Mattelierstraat 5, 7141 BP Groenlo | [nmto.nl/contact](https://www.nmto.nl/contact) ("Oude Calixtuskerk, Mattelierstraat 5, 7141 BP Groenlo") | **Medium:** Groenlo is in the Achterhoek (Gelderland), but listed under province Groningen in the CMS taxonomy filter. |
| **14** | **KoepelKathedraal Haarlem** | `koepelkathedraal` | Address: *Haarlem* (street and postcode omitted) | Address: **Leidsevaart 146, 2014 HE Haarlem**<br>Website: `https://koepelkathedraal.nl/` | [koepelkathedraal.nl](https://koepelkathedraal.nl/) ("Leidsevaart 146 2014 HE Haarlem") | **Medium:** Missing street address in CMS record. |
| **15** | **ARTIS-Groote Museum** | `artis-groote-museum` | Address: *Plantage Kerklaan 36, 1018 CZ* (city omitted) | City: **Amsterdam**<br>Address: Plantage Kerklaan 36, 1018 CZ Amsterdam | [artis.nl](https://www.artis.nl/nl/plan-je-bezoek/bereikbaarheid-parkeren) ("Plantage Kerklaan 36, Amsterdam") | **Low:** City name omitted in address block. |
| **16** | **Museum Prinsenhof Delft** | `museumprinsenhofdelft` | Status: active / open; Address: *Sint Agathaplein 4* | Status: **Tijdelijk gesloten voor renovatie**<br>Building address: Sint Agathaplein 1, 2611 HR Delft | [museumprinsenhofdelft.nl](https://www.museumprinsenhofdelft.nl/plan-je-bezoek) ("Museum Prinsenhof Delft is tijdelijk gesloten voor verbouwing en vernieuwing.") | **High:** The museum is undergoing a comprehensive multi-year renovation until ~2027. Sint Agathaplein 4 is the temporary info office. Visitors without prior warning may travel to Delft expecting an open museum. |
| **17** | **Missing Websites (10 active venues)** | *(Multiple slugs)* | Website: *(null / empty)* | See section 3 below for full list of verified official website URLs. | Official websites verified by identity tokens. | **High:** Prevents visitors from accessing ticket booking, accessibility information, and live opening times. |
